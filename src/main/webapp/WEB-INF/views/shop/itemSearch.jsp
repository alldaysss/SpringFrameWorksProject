...
<div class="container">
	...
	<div style="background-color: rgba(0,0,0,0.85); height: 70px; width: 100%; padding: 20px;" >
		<h4 style="margin: auto 10px;"><font color="white">상품검색결과 : <b>${searchString}</b></font></h4>	
	</div>
	<c:set var="cnt" value="0"/>
	<div class="row mt-3">
		<c:forEach var="vo" items="${scVos}">
			<div class="col-3">
				<div style="text-align: center;">
					<div onclick="location.href='${ctp}/alcohol/searchContent?idx=${vo.idx}&itemCodeJoin=${itemCodeJoin}';" style="cursor: pointer;" class="m-4">
    ...
    <div class="container">
      <c:if test="${fn:length(scVos) == 0}"><h3>제품 준비 중입니다.</h3></c:if>
    </div>
	</div>
	<hr/>
	<br/>
